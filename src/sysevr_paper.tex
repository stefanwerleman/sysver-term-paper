...
% @STEFAN Figure \ref{fig:sys-2} goes here.
...
% @STEFAN i have no idea how to format a table, it is crossing over into the other column
% images/sysevr/1.png show a screenshot of this table if making it a figure is an easy option
% the table should be in-place, needs to be moved so its in the Results section
\begin{table}[]
...
% @STEFAN Figure \ref{fig:af-3} goes here.
